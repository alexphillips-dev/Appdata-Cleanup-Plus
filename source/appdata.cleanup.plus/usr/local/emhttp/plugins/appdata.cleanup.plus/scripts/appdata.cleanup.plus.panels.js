(function(window, document, $) {
  ...
  ACP.renderModeStrip = function(context) {
    ...
    var safeModeTitle = isDeleteMode
      ? ACP.escapeHtml(ACP.t(strings, "safeModeCardTitle", "Safe Mode")) + ' <span class="acp-mode-card-state is-disabled">' + ACP.escapeHtml(ACP.t(strings, "disabledLabel", "Disabled")) + "</span>"
      : ACP.escapeHtml(ACP.t(strings, "safeModeCardTitle", "Safe Mode"));
    var html = [
      ...
      '<div class="acp-mode-card-title"><span>' + safeModeTitle + '</span><strong>' + ACP.escapeHtml(safeModeLabel) + "</strong></div>",
